...
function Teacher() {
  ...
  async function submitHandler(event) {
    ...
    try {
      ...
      if (!response.data.data.user.roles || response.data.data.user.roles.toLowerCase() !== "teacher") {
  ...
  return (
    <>
      {spinner ? (
        ...
        <section className="bg-gray-100 dark:bg-[#0B0C14] dark:text-white dark:border-gray-200 min-h-screen flex items-center justify-center p-8 w-full">
